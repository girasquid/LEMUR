...
echo "  server unix:/home/deploy/public_html/$APPNAME/current/tmp/sockets/unicorn.sock fail_timeout=0;" >> "/etc/nginx/sites-available/$APPNAME"
...
echo "" >> "/etc/nginx/sites-available/$APPNAME"
echo "  access_log /home/deploy/public_html/$APPNAME/current/log/access.log;" >> "/etc/nginx/sites-available/$APPNAME"
echo "  error_log /home/deploy/public_html/$APPNAME/current/log/error.log;" >> "/etc/nginx/sites-available/$APPNAME"
echo "" >> "/etc/nginx/sites-available/$APPNAME"
echo "  root /home/deploy/public_html/$APPNAME/current/public/;" >> "/etc/nginx/sites-available/$APPNAME"
echo "" >> "/etc/nginx/sites-available/$APPNAME"
